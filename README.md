...
Список фильмов с тегами. Статусы общие для всех, кто открыл ссылку.
...
Правьте `src/data/films.ts`. У каждого фильма должен быть уникальный `id` латиницей — по нему Firebase помнит статус. Теги пишутся массивом строк, их можно несколько. После правки задеплойте сайт.
